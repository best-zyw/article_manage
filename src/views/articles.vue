...
export default {
  ...
  methods: {
    ...
    init() {
      this.axios
        .get(`http://localhost:3000/articles?current_page=${this.page.current_page}`)
        .then((res) => {
          console.log(res);
          let Data=res.data.data
          this.tableData=Data.articles
...
.hygl .el-range-editor.el-input__inner{
  width: 350px;
}
 .hygl .el-pagination{
    display: flex;
  ...
  .hygl .el-table td, .el-table th{
    text-align: center;
  }
  .hygl .el-table th>.cell{
      text-align: center;
  }
</style>